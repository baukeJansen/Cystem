...
namespace Website.Views.HtmlHelpers
{
    public interface IRenderHelper : IViewContextAware
    {
        ...
        /* Buttons */
        Task<IHtmlContent> Button(string url, string buttonText, string icon, DisplaySetting options, object routeValues = null, ElementAction action = ElementAction.Load, object htmlAttributes = null, string cssClasses = "", bool link = true);
        ...
        Task<IHtmlContent> DeleteButton(string url, object routeValues = null, string buttonText = "Delete", DisplaySetting options = DisplaySetting.Render, ElementAction action = ElementAction.Close, object htmlAttributes = null);
        Task<IHtmlContent> DeleteModalButton(Value value, string buttonText = "Delete", DisplaySetting options = DisplaySetting.Render, ElementAction action = ElementAction.Close, object htmlAttributes = null);
