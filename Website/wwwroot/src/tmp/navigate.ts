...
(function (global, $) {
    ...
    var Action = function (method: string, url: Location, data: object, $source: JQuery, actionResult: ActionResult) {
        this.method = method;
        this.url = url;
        this.data = data;
    ...
    Navigate.prototype._beforeSend = function (action) {
        ...
        switch (action.actionResult) {
            ...
            case ActionResult.MODAL:
                action.modal = global.Cystem.Modal.open();
                break;
    ...
    Navigate.prototype._modal = function (action) {
